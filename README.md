...
3. ในหน้า Apps Script editor ให้สร้างไฟล์ `.gs` ตามชื่อในโฟลเดอร์ `apps-script/` ของโปรเจกต์นี้ (Code.gs, Utils.gs, Players.gs, Games.gs, Balances.gs, Settings.gs) แล้วคัดลอกเนื้อหาแต่ละไฟล์ไปวาง
